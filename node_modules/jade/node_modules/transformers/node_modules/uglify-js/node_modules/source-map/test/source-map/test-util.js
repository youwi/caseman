...
define(function (require, exports, module) {
  ...
  exports['test urls'] = function (assert, util) {
    ...
    assertUrl('http://');
    assertUrl('http://public.example.com');
    assertUrl('http://user:pass@public.example.com');
    assertUrl('http://public.example.com:80');
    assertUrl('http://public.example.com/');
    assertUrl('http://public.example.com/foo/bar');
    assertUrl('http://public.example.com/foo/bar/');
    assertUrl('http://user:pass@public.example.com:80/foo/bar/');

    assertUrl('//');
    assertUrl('//public.example.com');
    assertUrl('file:///public.example.com');
  ...
  exports['test normalize()'] = function (assert, util) {
    ...
    assert.equal(libUtil.normalize('http://public.example.com'), 'http://public.example.com');
    assert.equal(libUtil.normalize('http://public.example.com/'), 'http://public.example.com/');
    assert.equal(libUtil.normalize('http://public.example.com/./..//a/b/c/.././d//'), 'http://public.example.com/a/b/d/');
  };
  ...
  exports['test join()'] = function (assert, util) {
    ...
    assert.equal(libUtil.join('a', 'http://public.example.com'), 'http://public.example.com');
    ...
    assert.equal(libUtil.join('', 'http://public.example.com'), 'http://public.example.com');
    assert.equal(libUtil.join('.', 'http://public.example.com'), 'http://public.example.com');
    ...
    assert.equal(libUtil.join('http://foo.org//', ''), 'http://foo.org/');
    assert.equal(libUtil.join('http://foo.org//', '.'), 'http://foo.org/');
    assert.equal(libUtil.join('//public.example.com', ''), '//public.example.com/');
    assert.equal(libUtil.join('//public.example.com', '.'), '//public.example.com/');
    ...
    assert.equal(libUtil.join('http://foo.org/a', 'http://public.example.com'), 'http://public.example.com');
    ...
    assert.equal(libUtil.join('http://', 'public.example.com'), 'http://public.example.com');
    assert.equal(libUtil.join('file:///', 'public.example.com'), 'file:///public.example.com');
    assert.equal(libUtil.join('http://', 'ftp://example.com'), 'ftp://example.com');

    assert.equal(libUtil.join('http://public.example.com', '//foo.org/bar'), 'http://foo.org/bar');
    assert.equal(libUtil.join('//public.example.com', '//foo.org/bar'), '//foo.org/bar');
  };
